...
export function Pokemon({ obj }) {
	const index = obj.pokemon.url.substring(34).replace('/', '');
	const texto = obj.pokemon.name[0].toUpperCase() + obj.pokemon.name.substring(1);
